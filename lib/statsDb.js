...
// Löscht Snapshots/Aktionen, die älter sind als `days` Tage — sonst wachsen beide Tabellen
// unbegrenzt (bislang keine Bereinigung, seit statsCollector.js minütlich schreibt).
