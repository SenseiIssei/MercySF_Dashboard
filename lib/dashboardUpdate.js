...
function getCurrentSha() {
  try {
    // stderr ins Leere: ist das Verzeichnis kein git-Checkout (Installation aus
    // einem Archiv, Docker-Image), schreibt git sein "fatal: not a git
    // repository" sonst in das Server-Log. Der Fall ist hier keiner: der
    // Rueckgabewert null heisst genau das, und der Aufrufer kann damit umgehen.
