...
function ensurePty(id) {
  ...
  try {
    s.proc = pty.spawn(cliPath.CLI_PATH, [], {
      name: 'xterm-256color',
      cols: 100,
      rows: 30,
      cwd: cliPath.CWD,
...
module.exports = { ensurePty, killPty, restartPty, restartIfRunning, getStatus, attachSocket, write, resize, listActiveIds };
